...
//#endif
    ...
    IMGUI_API bool          Tabs(bool selected, const char* icon, const char* label, const ImVec2& size_arg);
    IMGUI_API bool          SubTabs(bool selected, const char* label, const ImVec2& size_arg);
